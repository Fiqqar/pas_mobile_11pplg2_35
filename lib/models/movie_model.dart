...
class Movie {
  ...
  factory Movie.fromJson(Map<String, dynamic> json) => Movie(
    ...
    image: json["image"] is Map<String, dynamic>
        ...
        : Image(
            medium: json["image"]?.toString() ?? "",
            original: json["image"]?.toString() ?? "",
          ),
  );
...
class Rating {
  ...
  factory Rating.fromJson(dynamic json) {
    if (json == null) {
      return Rating(average: null);
    }

    if (json is Map<String, dynamic>) {
      final avg = json["average"];
      return Rating(
        average: avg == null ? null : (avg as num).toDouble(),
      );
    }

    if (json is num) {
      return Rating(average: json.toDouble());
    }
